...
| 区域 | 状态 | 文档 | 说明 |
| --- | --- | --- | --- |
| Agent 主线 | **Phase 8 Active / Task 1 Active** | [roadmap.md](../roadmap.md) | Task 0 已完成；Task 1 已实现、待验收；Task 2-3 Planned |
| Phase 8：Grounded Retrieval / RAG Baseline | **Active / Task 0 Completed / Task 1 Active / Task 2-3 Planned** | [Phase 8 总览](./phase-08-grounded-retrieval/README.md) | 完整阶段目标、Task 编排、不变量与完成条件 |
...
| Task 1：Article Chunking & Embedding Index | **Active / 已实现 / 待验收** | Task 0 | 确定性 Chunk、stable identity、Embedding boundary、幂等 index / reindex | [Task 1](./phase-08-grounded-retrieval/task-01-article-chunking-embedding-index.md) |
...
Task 1 已由 Issue #50 正式定案并完成实现，当前等待验收。Task 2-3 的 Planned 文档仍不构成开工授权。
...
当前 Active Agent Task 为 Task 1 / Issue #50；实现已完成，下一步只做 Draft PR 技术验收与后续受托收口。
