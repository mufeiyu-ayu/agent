...
阶段 1-8：Completed
Active Agent Task：无
Next：web_fetch（前置 #115 / #116 已于 2026-09-18 / 2026-09-19 合并，未立 Issue）
...
| `web_fetch` 第一个真实工具 | Next | 只读、SSRF 防护、untrusted observation；前置 #115 / #116 已合并，未立 Issue，范围见 [pi-reference roadmap](../research/pi-reference/roadmap.md) |
