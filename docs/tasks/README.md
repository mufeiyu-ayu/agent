...
| Admin Console Task 2-4 | Planned | [admin-console.md](./admin-console.md) | 独立产品支线；启动时分别创建 Issue |
...
下一项正式 Agent 任务必须重新基于最新 `master`、学习收益和产品需求讨论后确定；`docs/research/**` 的候选路线不会自动变成正式 Task。
