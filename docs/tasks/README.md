...
| 阶段 4 Task 2 | Active | [phase-04-agent-runtime/task-02-agent-runtime-service.md](./phase-04-agent-runtime/task-02-agent-runtime-service.md) | 抽出 `AgentRuntimeService.runTurnStream()` |
