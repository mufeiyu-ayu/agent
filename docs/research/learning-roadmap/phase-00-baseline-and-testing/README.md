...
> 模块分类：**Core**。这是推荐学习模块，不是当前项目阶段状态；当前项目近期需要测试思想，是否实施以 `docs/tasks/**` 为准。
...
- `/Users/lihaoran/Desktop/codex/codex-rs/core/tests/common/test_codex.rs`
...
- `/Users/lihaoran/Desktop/codex/codex-rs/core/tests/suite/abort_tasks.rs`
